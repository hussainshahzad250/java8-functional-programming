...
public class SimpleStreamExample {
	...
	public static void main(String[] args) {
		/*
		 * Stream<Integer> s1 = Stream.of(1,2,3,4,5,6); s1.forEach(p->
		 * System.out.println(p)); System.out.println("=================");
		 * Stream<Integer> s2 = Stream.of(new Integer[] {1,2,3,4,5,6,}); s2.forEach(p->
		...
		Map<String, List<String>> personMap = PersonRepository.getAllPersons() // iterate all persons
		...
		List<String> personHobbies = PersonRepository.getAllPersons() // List of Persons
				...
				.distinct().collect(Collectors.toList());// collection to be returned
