...
import com.java8.request.Student;
...
public class Java8CommonProgrammingQA {
    ...
    public static void main(String[] args) {
        ...
        //2. Find the Students who stays in Karnataka and com.java8.features.sort them by their names
        ...
        List<String> contacts = studentList.stream()
                .flatMap(student -> student.getContacts().stream()).distinct().collect(Collectors.toList());
        ...
        System.out.println("Student count Dept wise "+collect);
        ...
        System.out.println("department who is having maximum number of students:"+results);
